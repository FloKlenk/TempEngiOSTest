...
//
//    func createTemplate(name: String, datasetName: String, operationName: String) {
//        let template = Template(name: name, datasetName: datasetName, operationName: operationName)
